<script lang="ts">
    ...
    async function handleLogin() {
        ...
        try {
            ...
            // Store the user and token directly in localStorage first
            localStorage.setItem("digiprop_token", result.token);
            localStorage.setItem("digiprop_user", JSON.stringify(result.user));
            ...
            console.log("Token stored:", {
                inLocalStorage: !!localStorage.getItem("digiprop_token"),
                inAuthStore: !!authStore.token,
            });
